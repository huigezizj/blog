        ...
        @section('content')
            ...
            <div class="menu_box">
                <ul>
                    ...
                    <li>
                        <h3><i class="fa fa-fw fa-clipboard"></i>栏目管理</h3>
                        <ul class="sub_menu">
                    ...
                    <li>
                        ...
                        <ul class="sub_menu" style="display: block">
                            <li><a href="{{url('admin/links')}}" target="main"><i class="fa fa-fw fa-link"></i>链接管理</a></li>
                            <li><a href="{{url('admin/nav')}}" target="main"><i class="fa fa-fw fa-navicon"></i>导航管理</a></li>
                            <li><a href="{{url('admin/config')}}" target="main"><i class="fa fa-fw fa-pencil"></i>网站配置</a></li>
            ...
            <div class="bottom_box">
                CopyRight © 2015. Powered By <a href="http://www.huigezizj.cc">http://www.huigezizj.cc</a>.
            </div>
            <!--底部 结束-->
