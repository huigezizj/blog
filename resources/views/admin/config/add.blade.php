        ...
        <form action="{{url('admin/config')}}" method="post">
            ...
            <table class="add_tab">
                ...
                <tr >
                    <th>类型：</th>
                    <td>
                        <input type="radio" name="field_type" value="input"id="r1" checked><label for="r1">input</label>
                        <input type="radio" name="field_type" value="textarea"id="r2" ><label for="r2">textarea</label>
                        <input type="radio" name="field_type" value="radio"id="r3" ><label for="r3">radio</label>
                        {{--<span><i class="fa fa-exclamation-circle yellow"></i>必填</span>--}}
                    </td>
                </tr>
                ...
                <tr>
                    <th>排序：</th>
                    <td>
                        <input type="text" class="sm" name="config_order">
                ...
                <tr>
                    <th>说明：</th>
                    <td>
                        <textarea name="config_tips" id="" cols="30" rows="10"></textarea>
