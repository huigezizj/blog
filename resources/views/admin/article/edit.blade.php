            ...
            <table class="add_tab">
                <tbody>
                            ...
                            <select name="cate_id">
                                ...
                                @if(isset($data))
                                    @foreach($data as $v)
                                        ...
                                        <option @if($v['cate_id']==$art['cate_id']) selected @endif value="{{$v['cate_id']}}">{{$v['cate_name']}}</option>
                                    @endforeach
                                    @endif
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" size="50" name="art_thumb"  value="{{$art->art_thumb}}">
                    ...
                    <tr>
                        <th></th>
                        <td>
                            <img src="{{asset($art->art_thumb)}}" alt="" id="img_thumb" style="max-height: 300px;max-width: 600px;">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <script id="editor" name="art_content" type="text/plain" style="width:860px;height:300px;">{!! $art->art_content !!}</script>
                            <script type="text/javascript">
                            //实例化编辑器
